...
const initializeMockData = () => {
    ...
    if (!localStorage.getItem('users')) {
        const users = [
            ...
            { id: 2, name: 'Manager User', email: 'manager@company.com', password: 'manager123', role: 'manager', tasks: [] },
            { id: 3, name: 'Employee User', email: 'employee@company.com', password: 'employee123', role: 'employee', tasks: [] },
        ];
    ...
    if (!localStorage.getItem('tasks')) {
        const tasks = [
            { id: 1, title: 'Task 1', description: 'This is a task for Admin', assignedTo: 1, status: 'pending' },
            { id: 2, title: 'Task 2', description: 'This is a task for Manager', assignedTo: 2, status: 'pending' },
            { id: 3, title: 'Task 3', description: 'This is a task for Employee', assignedTo: 3, status: 'pending' },
        ];
